...
namespace YAML
{
	...
	template <>
	struct convert<Volition::UUID>
	{
		static Node encode(const Volition::UUID &uuid)
		{
			Node node;
		...
		static bool decode(const Node &node, Volition::UUID &uuid)
		{
...
#define READ_SCRIPT_FIELD(FieldType, Type)          \
	...
	bool SceneSerializer::Deserialize(const std::string &filepath)
	{
		...
		{
			VL_CORE_ERROR("Failed to load .volition file '{0}'\n     {1}", filepath, e.what());
			return false;
		}
					...
					if (scriptFields)
					{
						...
						if (entityClass)
						{
							...
							for (auto scriptField : scriptFields)
							{
								...
								// TODO(Yan): turn this assert into Spine log warning
