...
#include "Volition/Physics/Physics2D.h"
...
#define VL_ADD_INTERNAL_CALL(Name) mono_add_internal_call("Volition.InternalCalls::" #Name, Name)
		...
		([]()
		 {
			...
			std::string managedTypename = fmt::format("Volition.{}", structName);
