...
#include "Volition/Scene/SceneSerializer.h"
#include "Volition/Utils/PlatformUtils.h"
#include "Volition/Math/Math.h"
#include "Volition/Scripting/ScriptEngine.h"
#include "Volition/Renderer/Font.h"
...
namespace Volition
{
	...
	void EditorLayer::OnAttach()
	{
		...
		else
		{
			...
			// If no project is opened, close Spine
	...
	{
		std::string filepath = FileDialogs::OpenFile("Volition Project (*.vproj)\0*.vproj\0");
		if (filepath.empty())
			return false;
	...
	{
		std::string filepath = FileDialogs::OpenFile("Volition Scene (*.volition)\0*.volition\0");
		if (!filepath.empty())
			OpenScene(filepath);
	}
	...
	void EditorLayer::OpenScene(const std::filesystem::path &path)
	{
		...
		if (path.extension().string() != ".volition")
		{
	...
	{
		std::string filepath = FileDialogs::SaveFile("Volition Scene (*.volition)\0*.volition\0");
		if (!filepath.empty())
		{
